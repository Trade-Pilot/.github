...
- 시장 캔들을 수집하는 작업 정보입니다.
- 시장 심볼이 상장되는 시점에 생성되며, 상장 폐지 시 비활성화됩니다.

| **프로퍼티 (한글)** | **프로퍼티 (영문)**        | **개념**            | **필수** | **불변** |
| :------------ | :------------------- | :---------------- | :----- | :----- |
| 식별자           | identifier           | 시장 캔들 수집 작업 식별자   | O      | O      |
| 시장심볼식별자       | symbol_identifier    | 수집하는 시장 심볼의 식별자   | O      | O      |
| 생성일시          | created_date         | 수집 작업이 생성된 시각     | O      | O      |
| 최근 수집된 일시     | last_collected_date  | 최근에 시장 캔들이 수집된 일시 | X      | X      |
| 최근 수집된 가격     | last_collected_price | 최근에 시장 캔들이 수집된 가격 | X      | X      |
| 상태            | status               | 시장 캔들 수집 상태       | O      | X      |
| 시간 간격         | interval             | 수집하는 시장 캔들의 시간 간격 | O      | O      |
